...
START TRANSACTION;
USE `tvdb`;
INSERT INTO `platform` (`id`, `name`) VALUES (1, 'Amazon Video');
INSERT INTO `platform` (`id`, `name`) VALUES (2, 'Netflix');
INSERT INTO `platform` (`id`, `name`) VALUES (3, 'Hulu');
...
START TRANSACTION;
USE `tvdb`;
INSERT INTO `tv_show` (`id`, `name`, `rating`, `description`, `imdb_url`) VALUES (1, 'Bob\'s Burgers', 'TV-PG', 'Bob Belcher runs his dream restaurant with his wife and three children as their last hope of holding the family together.', 'https://www.imdb.com/title/tt1561755/');
...
START TRANSACTION;
USE `tvdb`;
INSERT INTO `season` (`id`, `image_url`, `tv_show_id`) VALUES (1, 'https://images-na.ssl-images-amazon.com/images/I/61J8wQhWiCL.jpg', 1);
...
START TRANSACTION;
USE `tvdb`;
INSERT INTO `episode` (`id`, `number_in_season`, `title`, `directed_by`, `written_by`, `description`, `original_air_date`, `season_id`) VALUES (1, 1, 'Human Flesh', 'Anthony Chun', 'Loren Bouchard, Jim Dauterive', 'Louise wanted to \"up the ante\" at Show & Tell, so she told the class her dad, Bob, uses human remains in Bob\'s Burgers. Linda\'s jealous ex-fiancée, Hugo, is the new health inspector sent to investigate. Tina and Louise advise Linda to flirt with Hugo to keep the restaurant open. Hugo is an amateur poet: \"Inspector of health, inspector of pain. I came in search of human remains. And I found a piece of human flesh I thought I\'d never see again---my heart.\" Gene makes a delivery next door to Mort the mortician. With kids, condiments, buttons, candy caskets and angry mobs: this may be one Labor Day - slash - Anniversary Bob and Linda Belcher never forget! Written by LA-Lawyer', '2011-01-09', 1);
